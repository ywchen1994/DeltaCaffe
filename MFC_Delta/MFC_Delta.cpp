...
BEGIN_MESSAGE_MAP(CMFC_DeltaApp, CWinApp)
...
// 僅有的一個 CMFC_DeltaApp 物件

CMFC_DeltaApp theApp;


// CMFC_DeltaApp 初始設定

BOOL CMFC_DeltaApp::InitInstance()
{
